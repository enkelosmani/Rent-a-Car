...
if(isset($_POST['shto'])){
    modifikoAutomjet($automjetiid,$_POST['emri'],$_POST['kategoria'],
    $_POST['nrregjistrimi'],$_POST['pershkrimi']);
}
?>
...
<section class="section-shto-modifiko container">
    ...
    <div class="forma">
        ...
        <form id="automjeti" method="post">
            ...
            <div class="inputAndLabels">
                <div class="butonat">
                    <input type="submit" id="shto" name="shto" class="shtoModifiko" value="Ruaj">
                </div>
            </div>
        </form>
    </div>
